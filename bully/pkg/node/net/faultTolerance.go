...
*/
func SafeRMI(tipo MsgType, dest *SMNode, tryNextWhenFailed bool, elezione *MsgElection, ok *MsgOk, coord *MsgCoordinator) (failedNodeExistence bool) { //opt ...interface{}) {
