...
# compile serviceregistry
WORKDIR /distributed-election/serviceregistry/cmd
RUN CGO_ENABLED=0 GOOS=linux GOARCH=amd64 go build -v -o /distributed-election/bin/serviceregistry
